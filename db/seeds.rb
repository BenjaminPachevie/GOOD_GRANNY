...
['../../assets/images/jacqueline1.jpeg', '../../assets/images/jacqueline2.jpeg'].each do |photo|
  jacqueline.photos.attach(
    io: File.open(photo), filename: "jacqueline#{count += 1}.png", content_type: 'image/png'
  )
end
...
Granny.create(name: "Françoise", presentation: "La cuisine de Françoise est un melting-pot culturel, où elle marie les
saveurs de son héritage mexicain avec son esprit aventureux. Ses plats éclectiques témoignent de son amour pour la
cuisine.", pictures: "", location: ["75011", "75020"], price: 39)

Granny.create(name: "Jeannine", presentation: "La cuisine de Jeannine est un laboratoire de saveurs, où elle expérimente
avec des techniques classiques et modernes. Son expertise réside dans sa capacité à transformer des ingrédients simples
en délices gastronomiques", pictures: "", location: ["75012", "75013"], price: 42)

Granny.create(name: "Mauricette", presentation: "La cuisine de Mauricette est un espace d'innovation, où elle combine
...
Granny.create(name: "Yvette", presentation: "La cuisine de Yvette est un lieu où les générations se rassemblent pour
...
Granny.create(name: "Colette", presentation: "Les doigts agiles de Colette racontent des histoires à travers des points.
...
Granny.create(name: "Thérèse", presentation: "La machine à coudre de Thérèse est son compagnon constant, l'aidant à
...
Granny.create(name: "Paulette", presentation: "Les compétences en couture de Paulette vont de la broderie délicate à
...
Granny.create(name: "Simone", presentation: "La salle de couture de Simone est un pôle de créativité, où elle conçoit et
...
Granny.create(name: "Ginette", presentation: "Les mains de Ginette ont cousu d'innombrables souvenirs dans le tissu. Ses
...
Granny.create(name: "Bernadette", presentation: "Bernadette est une bibliothécaire à la retraite passionnée par la
...
Granny.create(name: "Madeleine", presentation: "Madeleine est une ancienne infirmière qui a consacré sa vie à prendre
...
Granny.create(name: "Lucienne", presentation: "Lucienne est une artiste dans l'âme, ayant fait carrière comme peintre.
...
Granny.create(name: "Micheline", presentation: "Micheline est une enseignante à la retraite qui inculque à ses
petits-enfants le goût d'apprendre. Sa nature patiente et encourageante fait d'elle la personne de référence pour
obtenir de l'aide aux devoirs et des conseils de vie.", pictures: "", location: ["75008", "75016", "75017"], price: 39)

Granny.create(name: "Raymonde", presentation: "Raymonde eu une carrière réussie en tant que comptable dévoué. Son souci
du détail et ses compétences analytiques ont fait d'elle un atout inestimable pour son entreprise. Elle profite
...
Granny.create(name: "Huguette", presentation: "Huguette est une femme d'affaires résiliante qui a transformé son petit
business en une boulangerie locale florissante. Son esprit d’entreprise et son engagement envers la qualité ont fait de
ses pâtisseries les préférées de la communauté. Aujourd'hui à la retraite, elle passe son temps à expérimenter de
nouvelles recettes et à mentorer de futurs entrepreneurs.",
